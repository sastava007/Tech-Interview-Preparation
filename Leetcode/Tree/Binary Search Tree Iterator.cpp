/*  
    Expected TC: O(1) average(amortized) time. Though it looks like that when we call for right child it will process N nodes, but it will not process N nodes always. 
